...
-- MEMBER 테이블 생성
CREATE TABLE MEMBER(
    MEMBER_ID VARCHAR2(20), -- 가변 길이 문자열 20바이트(영어 숫자만 작성시 20글자)
    MEMBER_PWD VARCHAR2(20),
    MEMBER_NAME VARCHAR2(30), -- 한글 3바이트 * 10글자 == 30
...
CREATE TABLE USER_USED_NN(
    USER_NO NUMBER NOT NULL, -- 사용자 번호 (무조건 있어야 함)
                    --> 컬럼레벨 제약조건 설정
    USER_ID VARCHAR2(20) ,
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KSH.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("KSH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KSH.PK_USERNO_USERID)에 위배됩니다
...
-- ORA-02291: 무결성 제약조건(KSH.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
WHERE GRADE_CODE = 10;
-- ORA-02292: 무결성 제약조건(KSH.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
-- ORA-02290: 체크 제약조건(KSH.GENDER_CHECK)이 위배되었습니다
