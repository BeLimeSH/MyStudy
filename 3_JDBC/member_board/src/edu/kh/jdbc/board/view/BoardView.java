...
public class BoardView {
	...
	private void selectOne(Member loginMember) {
		...
		try {
			...
			System.out.println("------------------------------------------------------------");
			System.out.printf("번호 : %-3d |  제목 : %-20s\n", board.getBoardNo(), board.getBoardTitle());
			System.out.println("------------------------------------------------------------");
			...
			System.out.println("0. 게시판 메뉴 돌아가기");
			...
			case 2: case 3: 
				...
				Reply reply = null; //확인 된 댓글을 참조할 변수
	 ...
	 * 	  클래스를 자바에서 제공함.
	 * 
	 * 	  (StringBuffer / StringBuilder는 사용방법은 똑같음)
	 * 	  -> 차이점은 동기/비동기 차이.
	 * */
	...
	private String inputContent() {
		...
		while(true) { //@exit가 입력될 때까지 무한히 문자열을 입력 받아 하나의 변수에 누적
