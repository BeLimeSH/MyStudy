...
public class LoadXML {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//Property : 속성(데이터)
			//prop.gerProperty("driver") : XML에서 얻어온 값 중
			...
			//외부 파일 미사용
			String str = "orcale.jdbc.driver.OracleDriver2";
