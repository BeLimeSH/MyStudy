...
public class Employee {
	...
	private Date hireDate;		//입사일(import java.sql.Date)
	private Date emtDate;		//퇴사일
	...
	public Employee(int empId, String empName, String empNo, String email, String phone, String deptCode,
			String jobCode, String salLevel, int salary, double bonus, int managerID, Date hireDate, Date emtDate,
			char entYN) {
		super();
		this.empId = empId;
