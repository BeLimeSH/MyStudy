...
document.getElementById("btn1").addEventListener("click", function(){
    ...
    // 문자열.indexOf("str") : 문자열에서 "str"과 일치하는 부분이 시작되는 index 반환
    //                         없으면 -1 반환
    ...
    console.log(str1.lastIndexOf("l")); //9 (뒤에서부터 먼저 검색된 인덱스 반환)
    console.log(str1.indexOf("a")); //-1

    //문자열.substring(시작인덱스, 종료인덱스(미만)) : 문자열 일부 잘라내기
    const str2 = "abcdefg";
