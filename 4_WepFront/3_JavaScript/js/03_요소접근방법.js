...
function accessId(){
    ...
    if (bgColor == 'red') {
        div1.style.backgroundColor = "green"; //배경색을 green로 변경
    } else {
...
function accessTagName(){
    ...
    for(let i=0; i < arr.length; i++) {
        ...
        arr[i].style.backgroundColor = "rgb(45, 35, "+ (25 * num) +")"
    }
}
...
function inputTest(){
    ...
    // ** innerText/innerHTML은 요소의 내용 (시작태그, 종료태그 사이에 작성된 내용)을
    // 얻어오거나 변경할 때만 사용 가능.
    
    // ** input은 value를 이용해서 값을 얻어오거나 변경할 수 있음.
