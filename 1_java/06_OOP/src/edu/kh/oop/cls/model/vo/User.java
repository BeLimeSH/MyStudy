...
public class User {
	...
	public User(String userId, String userPw, String userName, 
		...
		// 사용하는 이유 -> 중복 코드 제거, 코드 길이 감소, 재사용성 증가
		//(가독겅이 어려운 경우가 생길 수 있어 많이 사용되진 않음)
	...
	*/
	...
	// *** 오버로딩(Over Loading) ***
	// - 클래스 내에 동일한 이름의 메서드(생성도 포함)를 여러 개 작성하는 기법
	...
	// 매개변수의 개수, 타입은 같지만 순서가 달라서 오버로딩 성립
	
	//public User(int userAge, String userName) {} -> 에러
	// 매개변수의 개수, 타입, 순서가 모두 같아서 오버로딩 불가능
	// -> 변수명은 신경쓰지 않는다
